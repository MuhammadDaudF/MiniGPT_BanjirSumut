# tinygpt_char.py
# Pendekatan 1: Character Tokenization
# Setiap karakter individual menjadi satu token
...
# ----------------------------
# Character Tokenizer (manual, tanpa library eksternal)
# ----------------------------
...
print("Vocab size (character):", vocab_size)
...
print(f"\nFinal loss (character): {loss.item():.4f}")
